...
#: Sensivity SUFFIXES
m.npdp = Suffix(direction=Suffix.EXPORT) #set the perturbed value of parameter, definition is p_before-p_after, in this case is 0.5 (5 to 4.5)
m.c1p.set_suffix_value(m.npdp, 0.0)
m.c2p.set_suffix_value(m.npdp, 0.2)
...
m.c1p.set_suffix_value(m.DeltaP, 0.0)
m.c2p.set_suffix_value(m.DeltaP, 0.2)
